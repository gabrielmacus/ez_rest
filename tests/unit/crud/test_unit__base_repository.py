...
def test_read_by_id(repository, id, found):
    item1 = Product(id=1,name="Demo",category="Food")    
    item2 = Product(id=2,name="Demo 2",category="Sports")
...
def test_update(repository, partial_data, expected_item):
    item = Product(id=1,name="Potato",category="Food")
    item2 = Product(id=2,name="Ball",category="Sports")
